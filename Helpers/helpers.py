...
# Maps bones to a their names
KEYPOINT_EDGE_INDS_TO_NAME = {
    (0, 1): 'nose-lefteye',
    (0, 2): 'nose-righteye',
    (1, 3): 'lefteye-leftear',
    (2, 4): 'righteye-rightear',
    (0, 5): 'nose-leftshoulder',
    (0, 6): 'nose-rightshoulder',
...
def _keypoints_and_edges_for_display(keypoints_with_scores,
  ...
  Returns:
    A (keypoints_xy, edges_xy, edge_colors, edge_names) containing:
  ...
  for idx in range(num_instances):
    ...
    for edge_pair, color in KEYPOINT_EDGE_INDS_TO_COLOR.items():
      if (kpts_scores[edge_pair[0]] > keypoint_threshold and
        ...
        edge_names.append(KEYPOINT_EDGE_INDS_TO_NAME[edge_pair])
  ...
  return keypoints_xy, edges_xy, edge_colors, edge_names
